...
const projectData = {
  ...
  project2: {
    ...
    description:
      'Minute-level time series forecasting platform with advanced clustering and tailored regression models.',
    fullDescription:
      'Collaborated with Move Tickers (fictitious SaaS company) to develop a machine learning platform predicting minute-level stock price movements for NASDAQ-100 companies. The system processes 10 years of high-frequency trading data to support algorithmic trading strategies and wealth management decisions.',
    technologies: [
      'Python',
      'Flask',
      'PostgreSQL',
  ...
  project3: {
    ...
    tag: 'Healthcare ML',
    description:
      'Comparing regression vs. classification approaches for 30-day readmission risk prediction.',
    fullDescription:
      'Developed and evaluated multiple machine learning models to predict 30-day hospital readmissions for diabetes patients. This healthcare analytics project addresses class imbalance and dimensionality challenges to enable proactive patient care strategies.',
    technologies: [
      'Python',
      'Scikit-learn',
      'SMOTE',
  ...
  project4: {
    ...
    tag: 'Data Analytics',
    description:
      'Interactive Power BI analytics for UN Sustainable Development Goals monitoring.',
    fullDescription:
      'Developed an interactive Power BI dashboard monitoring progress toward United Nations Sustainable Development Goals, focusing on the critical relationship between water access, sanitation infrastructure, and infant mortality rates in developing countries.',
    technologies: [
      'Power BI',
      'DAX',
      'Excel',
  ...
  project5: {
    ...
    description:
      'Predictive pipeline using team attributes, player data, and machine learning models.',
    fullDescription:
      'Built a comprehensive sports analytics pipeline predicting English Premier League match results. The system merges match and player datasets, calculates team-level attributes, and applies machine learning algorithms to forecast outcomes.',
    technologies: [
      'Python',
      'Pandas',
      'NumPy',
  ...
  project6: {
    ...
    description:
      '5+ international mobility programs across Europe developing leadership and cultural competence.',
    fullDescription:
      'Participated in and led multiple Erasmus+ international collaboration projects focused on cultural exchange, technical education, and environmental awareness. These experiences developed cross-cultural communication, leadership, and project coordination skills across diverse European contexts.',
    technologies: [
      'Project Management',
