  ...
  _searchIndex = [
    {
      ...
      label: 'About Me',
      icon: 'bi-person-fill',
      keywords: 'about me background education bio who profile',
    },
    {
      id: 'skills',
      label: 'My Skills',
      ...
      keywords:
        'skills competencies tech expertise ml nlp computer vision mlops backend',
    },
    {
      id: 'projects',
      label: 'Projects',
      icon: 'bi-folder-fill',
      keywords: 'projects work portfolio builds featured ml systems',
    },
    {
      id: 'documents',
      label: 'Documents',
      icon: 'bi-folder2-open',
      keywords: 'documents files my documents',
    },
    {
      id: 'contact',
      label: 'Contact Me',
      ...
      keywords:
        'contact email linkedin github network reach get in touch outlook',
    },
    {
      id: 'resume',
      label: 'Resume (CV)',
    ...
    },
    {
      ...
      label: 'Games',
      icon: 'bi-controller',
      keywords: 'games play minesweeper',
    },
    {
      id: 'minesweeper',
      label: 'Minesweeper',
      icon: 'bi-grid-3x3-gap-fill',
      keywords: 'minesweeper mines game play',
    },
    {
      id: 'programs',
      label: 'Default Programs',
      icon: 'bi-box-seam-fill',
      keywords: 'default programs technologies stack tools installed software',
    },
    {
      id: 'computer',
      label: 'Computer',
      icon: 'bi-pc-display',
      keywords: 'computer system drives specs hardware my computer',
    },
    {
      id: 'controlpanel',
      label: 'Control Panel',
      icon: 'bi-sliders',
      keywords:
        'control panel settings preferences personalization theme dark light',
    },
    {
      id: 'help',
      label: 'Help and Support',
      icon: 'bi-question-circle-fill',
      keywords: 'help support guide assistance how to faq',
    },
  ];
...
function filterStartMenu(query) {
  ...
  results.querySelectorAll('.start-search-hit').forEach((el) => {
    el.addEventListener('click', () =>
      openSearchResult(getSearchIndex().find((x) => x.id === el.dataset.id)),
    );
  });
}
